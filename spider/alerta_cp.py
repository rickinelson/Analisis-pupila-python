...
condicion1 = cursor.execute("SELECT cuenta, archivo, rt, condicion FROM datos WHERE warning = 'no'  AND response = 'OK' AND condicion = 'C' AND d2 >= '0.3' AND d2 <= '0.5'limit 5" )#azul
condicion1 = cursor.fetchall()

len(condicion1)

condicion2 = cursor.execute("SELECT cuenta, archivo, rt, condicion FROM datos WHERE warning = 'double' AND response = 'OK' AND condicion = 'C'  AND d2 >= '0.3' AND d2 <= '0.5'limit 5") #naranjo
...
def huachimingo (condicion, nombre_archivo):
    ...
    plt.suptitle('Dilatacion pupilar red alerta', fontsize=25)
...
plt.plot([1,1,1], label="No cue", markersize = 8, color = 'blue')
plt.plot([1,2,3], label="Double cue", markersize = 8, color = 'orange')
plt.plot([0,0,0], label="Cue on set", marker = '|', markersize = 10,linewidth = 0, color = 'grey')
plt.plot([5,3,2], label="Target on set",marker = '|', markersize = 10,linewidth= 0, color = 'black')
plt.plot([1,1,1], label= "Respuesta", marker= 'd', markersize = 6, linewidth= 0,color = 'orange')
plt.plot([1,1,1], label= "Respuesta", marker= 'd', markersize = 6, linewidth= 0,color = 'blue')
plt.plot([1,1,1], label= "p < 0,05", marker= '_', markersize = 10,color = 'green')
plt.plot([1,1,1], label= "p > 0,05", marker= '_', markersize = 10,color = 'red')
